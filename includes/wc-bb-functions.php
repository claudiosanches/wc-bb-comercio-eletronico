 ...
 * @return string
 */
function wc_bb_get_bank_slip_url( $order_key ) {
	$url = WC()->api_request_url( 'WC_BB_Bank_Slip_Gateway' );
 ...
 * @return mixed
 */
function _wc_bb_get_order_meta( $order, $key ) {
	$value = '';
 ...
 */
function _wc_bb_update_order_meta( $order, $key, $value ) {
